  ...
  describe("checkReorder", () => {
    ...
    describe("searchF", () => {
      ...
      it("should return the products whose price is less than (or equal to) the specified value When the key is price", function () {
        const result = cat.searchF({price:25.01});
         expect(result.FinalProducts).to.have.members([10,10,12,25.0]);
      });
      it("should returns the products with the keyword in their nameWhen the key is keyword", function () {
        ;
